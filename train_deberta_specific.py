...
print(f"Training for model: {TARGET_MODEL}")

df = pd.read_csv("balanced_dataset.csv")

df = df[df["model_name"] == TARGET_MODEL].copy()
...
model_path = "/workspace/amit/Jahanvi/deberta-v3-base"
...
args = TrainingArguments(
    output_dir=f"./deberta_{TARGET_MODEL.replace(':','_')}",
